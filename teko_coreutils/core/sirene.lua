...
Citizen.CreateThread(function()
	...
	while true do
		...
		if IsPedInAnyVehicle(PlayerPedId(), false) and (ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job and ESX.PlayerData.job.name == 'ambulance' ) then
			Citizen.Wait(0)
		else
			Citizen.Wait(2500)
		end
